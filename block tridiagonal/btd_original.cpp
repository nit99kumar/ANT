...
int main()
{
        ...
        n = (1/h)-1;
        row = 2; col = 2;
        //row and column for reach matrix of the tridiagonal system
        ...
        for(i=n-2; i>=0; i--)
        {
                Y = C1.transform(i);cout << "Y\n"; Y.display();cout << "X\n"; X.display();
                Z = Y * X;cout << "Z\n"; Z.display();
                W = D1.transform(i);cout << "W\n"; W.display();
                W = W - Z;cout << "W\n"; W.display();
